...
**硬规则：不要啰嗦。** 写完后必须主动压缩一轮：删掉多余铺垫、重复解释、清单式导语、"这里主要看/这一步重点看"这类刻意串场。能用截图、命令、输出说明的，不再补一段解释。文章要像人在边跑 demo 边记要点，不像培训稿。
...
- **少讲废话**：演示类文章直接给输入、截图、结果和一句判断。不要把每张图前后都写成"我们要看什么"。
...
- **交稿前压缩**：全文至少删一轮。删除不影响理解的形容词、过渡句、步骤说明、截图说明、重复结论；保留事实、动作、截图、输出。
